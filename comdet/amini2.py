    ...
    for s in range(10):
        ...
        for l in range(klen):
            for k in range(klen):
                for i in range(n):
                    for j in range(n):
                        Phatlk[l][k]=Phatlk[l][k]+A[i][j]*pihatil[l][i]*pihatil[k][j]
                Phatlk[l][k]=Phatlk[l][k]/nkl[l][k]
    #for i in range(klen):
    #    print("Amini'spia",pihatl[i]/n)             
    #print("Amini'sHab",Phatlk)
    return e
